...
- Update the class Base by adding the class method def savetofile(cls, listobjs): *that writes the JSON string representation of list*objs to a file
- Update the class Base by adding the static method def fromjsonstring(jsonstring): *that returns the list of the JSON string representation json*string
